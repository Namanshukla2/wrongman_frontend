...
export default function Admin() {
  ...
  // Upload local files → backend /api/upload → Cloudinary → URLs + publicIds
  ...
  const submit = async (e) => {
    ...
    const data = {
      ...
      cdnPublicIds: form.cdnPublicIds || [],
    };
      ...
      <div className="min-h-screen pt-20 skull-pattern" style={{ background: 'var(--bg)' }}>
        <div className="max-w-7xl mx-auto px-4 py-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
            ...
            <button
              onClick={() => {
                if (window.confirm('Reset all products?')) {
                  resetToDefault();
                  toast.success('Reset!');
                }
              }}
            ...
            {['products', 'orders'].map((t) => (
              <button
                ...
                className={`px-6 py-3 rounded-xl font-medium capitalize transition-all ${
                  tab === t ? 'bg-red-600 text-white shadow-lg shadow-red-600/25' : ''
                }`}
            ...
            <div>
              {adding ? (
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          ...
                          required
                          style={inputStyle}
                          className="w-full rounded-xl px-4 py-2 focus:outline-none focus:ring-2 focus:ring-red-500/40"
                        />
                      </div>
                      <div>
                        <label className="block text-sm mb-1" style={{ color: 'var(--muted)' }}>
                      ...
                      <div>
                        ...
                        <input
                          ...
                          style={inputStyle}
                          className="w-full rounded-xl px-4 py-2 focus:outline-none focus:ring-2 focus:ring-red-500/40"
                          placeholder="e.g. Oversized, Baggy, Joggers, Printed"
                        />
                      </div>
                      <div>
                        <label className="block text-sm mb-1" style={{ color: 'var(--muted)' }}>
                      ...
                      <div className="md:col-span-2">
                        ...
                        <p className="text-xs mt-1" style={{ color: 'var(--muted)' }}>
                          Or paste image URLs manually below.
                        </p>
                      </div>
                ...
                <button
                  ...
                  className="bg-red-600 hover:bg-red-700 text-white font-bold px-6 py-3 rounded-xl mb-8 flex items-center gap-2"
                >
                  + Add Product
                </button>
              )}
              ...
              <div className="grid gap-4">
                {products.map((p) => (
                  <div
                    key={p.id}
                    className="rounded-xl p-4 border flex flex-col md:flex-row gap-4"
                    style={{ background: 'var(--card)', borderColor: 'var(--border)' }}
                  >
                    ...
                    <div className="flex-1">
                      <div className="flex flex-wrap items-center gap-2 mb-1">
                        ...
                        {p.brand && (
                          <span className="text-xs bg-red-600/10 text-red-600 px-2 py-0.5 rounded">
                            {p.brand}
                          </span>
                        )}
                        {p.featured && (
                    ...
                    <div className="flex md:flex-col gap-2">
                      ...
                      <button
                        ...
                        className="flex-1 px-4 py-2 rounded-lg text-sm font-medium bg-red-600/10 text-red-600 hover:bg-red-600/20"
                      >
                        Delete
                      </button>
                    </div>
                      ...
                      <div className="flex flex-col md:flex-row justify-between gap-4 mb-4">
                        <div>
                          <div className="flex items-center gap-2 mb-1">
                            ...
                            <span
                              className={`text-xs px-2 py-0.5 rounded text-white capitalize ${
                                o.status === 'pending'
                                  ? 'bg-yellow-600'
                                  : o.status === 'confirmed'
                                  ? 'bg-blue-600'
                        ...
                        <select
                          ...
                          style={inputStyle}
                          className="rounded-lg px-3 py-1 text-sm focus:outline-none"
                        >
                        ...
                        {o.items?.map((it, i) => (
                          <div key={i} className="flex justify-between text-sm py-1">
                            ...
                            <span style={{ color: 'var(--fg)' }}>
                              ₹{((it.salePrice || it.price) * it.quantity).toLocaleString()}
                            </span>
                          </div>
                        ))}
                        <div
                          className="flex justify-between mt-3 pt-2 border-t font-bold"
