  ...
  const categories = [
    {
      name: 'T-Shirts',
      slug: 'tshirts',
      img: 'https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=300&h=400&fit=crop',
      count: '50+',
    },
    {
      name: 'Jeans',
    ...
    },
    {
      name: 'Jackets',
      slug: 'jackets',
      img: 'https://images.unsplash.com/photo-1551028719-00167b16eac5?w=300&h=400&fit=crop',
      count: '25+',
    },
    {
      name: 'Shirts',
    ...
    },
    {
      name: 'Caps',
      slug: 'caps',
      img: 'https://images.unsplash.com/photo-1588850561407-ed78c282e89b?w=300&h=400&fit=crop',
      count: '20+',
    },
  ];
  ...
  return (
    <>
      ...
      <div className="skull-pattern" style={{ background: 'var(--bg)' }}>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="text-center lg:text-left">
                <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full mb-6 bg-red-600/10 border border-red-600/20">
                  ...
                  <span className="text-red-600 font-bold text-xs tracking-wider uppercase">
                    Top Brands • Killer Prices
                  </span>
                  <Skull className="w-4 h-4 text-red-600" />
                </div>

                <h1
                  className="font-bebas text-6xl sm:text-7xl lg:text-[110px] leading-[0.9] mb-6"
                  style={{ color: 'var(--fg)' }}
                >
                  DRESS LIKE A
                ...
                <div className="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start">
                  <Link
                    href="/shop"
                    className="group bg-red-600 hover:bg-red-700 text-white font-bold py-4 px-8 rounded-xl text-lg transition-all hover:scale-105 animate-pulse-glow inline-flex items-center justify-center gap-2"
                  >
                  ...
                  <Link
                    ...
                    className="font-bold py-4 px-8 rounded-xl text-lg border-2 border-red-600 text-red-600 hover:bg-red-600 hover:text-white inline-flex items-center justify-center gap-2"
                  >
                    ☠️ New Arrivals
                  </Link>
                </div>
              ...
              <div className="relative hidden lg:block">
                <div className="relative z-10 rounded-3xl overflow-hidden shadow-2xl border-4 border-red-600/20">
                  <img
                    src="https://images.unsplash.com/photo-1552374196-1ab2a1c593e8?w=500&h=650&fit=crop"
                    alt="Wrong Man Fashion"
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
              {categories.map((c) => (
                <Link
                  ...
                  className="group relative h-64 md:h-72 rounded-2xl overflow-hidden border-2 hover:border-red-600 transition-all"
        ...
        <section className="py-16 md:py-24 px-4" style={{ background: 'var(--bg-2)' }}>
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row justify-between items-center mb-12 gap-4">
              ...
              <Link
                href="/shop"
                className="bg-red-600 hover:bg-red-700 text-white font-bold px-6 py-3 rounded-xl inline-flex items-center gap-2"
              >
                View All
              </Link>
            </div>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
              {featured.map((p) => (
                ...
                >
                  ...
                  <div className="p-4">
                    {p.brand && (
                      <span className="text-red-600 text-xs font-bold uppercase">{p.brand}</span>
                    )}
                    ...
                    <button
                      onClick={() => add(p)}
                      className="w-full bg-red-600 hover:bg-red-700 text-white font-bold py-2.5 rounded-xl"
                    >
                      Add to Cart
                    </button>
                  </div>
        ...
        {/* NEWSLETTER - only show when user is not logged in */}
        {!user && (
          <section className="py-16 md:py-24 px-4 bg-red-600">
            <div className="max-w-3xl mx-auto text-center">
              <Skull className="w-16 h-16 text-white mx-auto mb-5 animate-skull-pulse" />
              ...
              >
                <input
                  ...
                  className="flex-1 px-5 py-3.5 rounded-xl bg-white/15 border-2 border-white/30 text-white placeholder-white/60 outline-none"
                />
                <button
                  type="submit"
                  className="bg-white text-red-600 font-bold px-7 py-3.5 rounded-xl hover:bg-zinc-100 transition-colors"
                >
                  Subscribe
                </button>
              </form>
