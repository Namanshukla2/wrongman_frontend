...
export default function Home() {
  ...
  const categories = [
    ...
    { name: 'Jeans', slug: 'jeans', img: 'https://images.unsplash.com/photo-1542272604-787c3835535d?w=300&h=400&fit=crop', count: '30+' },
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 pt-28 pb-16 w-full">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="text-center lg:text-left">
                ...
                <p className="text-lg md:text-xl max-w-xl mx-auto lg:mx-0 mb-8 " style={{font:"blue"}} >
                  Dress well, Look well, Live well</p>
                ...
                <div className="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start">
                  <Link href="/shop" className="group bg-red-600 hover:bg-red-700 text-white font-bold py-4 px-8 rounded-xl text-lg transition-all hover:scale-105 animate-pulse-glow inline-flex items-center justify-center gap-2">
        ...
        <section className="py-16 md:py-24 px-4 bg-red-600">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <form className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
              <input type="email" placeholder="Enter your email…" className="flex-1 px-5 py-3.5 rounded-xl bg-white/15 border-2 border-white/30 text-white placeholder-white/60" />
              <button type="button" className="bg-white text-red-600 font-bold px-7 py-3.5 rounded-xl">Subscribe</button>
            </form>
          </div>
        </section>
      </div>
